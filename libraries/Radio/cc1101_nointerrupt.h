/**
 * Copyright (c) 2020 Victor Leung <yck011522@gmail.com>
 * Copyright (c) 2011 panStamp <contact@panstamp.com>
 * Copyright (c) 2016 Tyler Sommer <contact@tylersommer.pro>
 *
 * This file is part of the integral_timber_joints project.
...
#ifndef _CC1101_H_NOINTERRUPT
#define _CC1101_H_NOINTERRUPT
 ...
 * Packet length = 255 
 * Device address = 1 
 * Address check = Enabled Address Check and Broadcast on 0x00
 ...
 * TX power = 12
 * Address Check 
 * GDO0 mode = This signal is asserted (in RX) when a packet has been received with CRC OK and is de-asserted
 *             when the first byte is read from the RX FIFO.
 *              This mode allows us to detect incoming packets by performing digitalRead(GDO0 Pin).
 *              This mode requires CRC autoflush = true to avoid failed CRC messages to overflow the buffer.
 */
...
#define CC1101_DEFVAL_IOCFG0     0x07        // GDO0 Output Pin Configuration   // Changed to output HIGH when RX message available. see DN506
...
#define CC1101_DEFVAL_PKTCTRL1   0x0E        // Packet Automation Control       // Added CRC_AUTOFLUSH = True to avoid overflow.
...
// PATABLE values
#define PA_MinimalPower           0x03
#define PA_ReducedPower           0x1E
...
class CC1101
{
  ...
  public:
    ...
    bool sendDataSpecial(CCPACKET packet);
